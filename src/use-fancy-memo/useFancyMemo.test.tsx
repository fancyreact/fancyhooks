...
import { useFancyMemo } from './useFancyMemo';

describe('useFancyMemo', () => {
  test('should act like `useMemo` with `dependencyList` if there is no `fancyHelper`', (done) => {
    ...
    function Component() {
      ...
      const value = useFancyMemo(() => [], [color]);

      React.useEffect(callbackMock, [value]);
  ...
  test('should act like `useMemo` with empty `dependencyList` if there is no `fancyHelper`', (done) => {
    const callbackMock = jest.fn();
    const colors = ['teal', 'orange', 'springgreen', 'pink'];
  ...
  test('should apply `fancyHelper` in hook', (done) => {
    ...
    function Component() {
      ...
      // passing an inline function
      const value = useFancyMemo(() => [], [color], fancyHelperMock);
  ...
  test('should not apply `fancyHelper` in hook if `dependencyList` is empty array', (done) => {
    ...
    function Component() {
      ...
      // passing an inline function
      const value = useFancyMemo(() => [], [], fancyHelperMock);
